...
description: "Documentação completa de todos os endpoints da API StylePay"
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="qrcode"
    href="/api-reference/gateway/request-qrcode"
  >
  ...
  <Card
    ...
    icon="paper-plane"
    href="/api-reference/gateway/pix-payment"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/api-reference/wallet/transactions"
  >
